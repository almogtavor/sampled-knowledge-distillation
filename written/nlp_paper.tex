...
While SampledKD is principled and builds on successful ideas in sampled softmax and RS-KD, our results do not yet match full KD at equal wall-clock.
This may be due to (i) scale and quantization, (ii) interaction between positional selection and class sampling, and (iii) optimization techniques (e.g. softmax elimination) (iv) implementation details.
