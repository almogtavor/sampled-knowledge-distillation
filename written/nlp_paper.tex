...
\begin{abstract}
	...
	On small-scale experiments (Qwen3-8B→0.6B; 4M tokens), token-selective KD beats the full KD on all baselines.
	SampledKD delivers an $8k$-$16k\times$ logit-storage reduction with competitive accuracy, suggesting these efficiency gains should be more impactful at larger scales.
...
TSKD provides strong efficiency-accuracy trade-offs and outperforms full KD in our benchmarks.
