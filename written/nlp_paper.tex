...
It is important to mention a high degradance in perplexity, dependent on hyperparameter settings.
...
Lower choices of $M_t$ have caused high perplexity degradance.
Let $S_t = U_t \cup M_t$.
